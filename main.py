...
class Client():
    ...
    def connect(self):
        ...
        with open('download_random2','a') as f:
            f.write("{0},{1},{2},{3},{4}\n".format(datetime.datetime.now(),self.round,
                                                   self.defaultGateway.address,float(lat),int(status)))
        self.round += 1
                      
node1 = Gateway('10.139.40.85', 0.15, datetime.datetime.strptime('2018 Feb 15 18:59:15', '%Y %b %d %H:%M:%S'), False)
node2 = Gateway('10.139.40.122', 0.20, datetime.datetime.strptime('2018 Feb 15 18:20:15', '%Y %b %d %H:%M:%S'),False)
node3 = Gateway('10.138.57.2', 0.02, datetime.datetime.strptime('2018 Feb 15 18:45:07', '%Y %b %d %H:%M:%S'), False)
node4 = Gateway('10.228.0.83', 0.5, datetime.datetime.strptime('2018 Feb 15 18:47:21', '%Y %b %d %H:%M:%S'), False)
node5 = Gateway('10.138.77.2', 0.78, datetime.datetime.strptime('2018 Feb 15 18:26:19', '%Y %b %d %H:%M:%S'), False)
node6 = Gateway('10.138.85.130', 0.35, datetime.datetime.strptime('2018 Feb 15 19:00:01', '%Y %b %d %H:%M:%S'), True)
node7 = Gateway('10.139.17.4', 2.1, datetime.datetime.strptime('2018 Feb 15 18:26:04', '%Y %b %d %H:%M:%S'), False)
node8 = Gateway('10.139.37.194', 1.5, datetime.datetime.strptime('2018 Feb 15 18:30:14', '%Y %b %d %H:%M:%S'), True)
node9 = Gateway('10.138.62.2', 0.04, datetime.datetime.strptime('2018 Feb 15 19:47:59', '%Y %b %d %H:%M:%S'), False)
node10 = Gateway('10.138.25.67', 0.09, datetime.datetime.strptime('2018 Feb 15 17:59:07', '%Y %b %d %H:%M:%S'), False)

listGW = [node1,node2,node4, node8, node9, node10, node6,node7, node5, node3]
client4= Client('10.139.40.77', [], listGW, node7)
